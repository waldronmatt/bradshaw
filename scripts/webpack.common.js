  ...
  return {
    ...
    plugins: [
      new HtmlWebPackPlugin({
        filename: "index.html",
        title: "Bradshaw",
        description: "A full stack TypeScript application using OOP and MVC patterns.",
        template: "./src/pages/template.ejs",
        excludeChunks: ['server'],
        meta: {
          'keywords': 'typescript, node.js, express, object oriented programming, mvc architecture, webpack',
